...
The following example will clone the "[DMA FCE](https://github.com/Infineon/mtb-example-xmc-dma-fce)" application with the desired name "MyDMAFCE" configured for the *KIT_XMC47_RELAX_V1* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_XMC47_RELAX_V1 --app-id mtb-example-xmc-dma-fce --user-app-name MyDMAFCE --target-dir "C:/mtb_projects"
   ```
...
Document title: *CE232629* - *XMC&trade; MCU: DMA FCE*
